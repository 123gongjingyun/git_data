            ...
            <Card>
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    <Button
                      size="small"
                      onClick={() => void loadWorkflowDefinitions(true)}
                    >
                      重新加载
                    </Button>
                    <Button
                      ...
                      onClick={handleResetWorkflowLibraryToDefaults}
                    >
                      恢复默认模板
                    </Button>
                    <Button
                ...
                <div style={{ marginBottom: 12, display: "flex", gap: 8, flexWrap: "wrap" }}>
                  <Tag color="blue">商机流程：{workflowList.filter((item) => item.target === "opportunity").length}</Tag>
                  <Tag color="purple">解决方案流程：{workflowList.filter((item) => item.target === "solution").length}</Tag>
                ...
                <Table<WorkflowDefinition>
                  ...
                  columns={[
                    ...
                    },
                    {
                      ...
                      dataIndex: "nodes",
                      key: "nodes",
                      render: (nodes: WorkflowNode[]) =>
                        nodes && nodes.length > 0 ? nodes.length : 0,
                    },
                    {
                      title: "状态",
                      dataIndex: "enabled",
                      ...
                      render: (record: WorkflowDefinition) => (
                        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                          ...
                          <Button
                            ...
                            onClick={() => handleSetWorkflowAsDefault(record)}
                          >
                            设为默认
                          </Button>
                          <Button
                            ...
                            size="small"
                            disabled={!canEditWorkflow}
                            onClick={() => handleToggleWorkflowEnabled(record)}
                          >
